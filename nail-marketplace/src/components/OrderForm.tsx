...
export function OrderForm() {
  const { currentUser, selectedNailType, placeOrder, getOrderBook } = useMarketplaceStore();
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="bg-card border rounded-lg p-3">
            <div className="text-sm font-medium text-muted-foreground mb-1">Trading Product</div>
            <div className="text-lg font-semibold">{selectedNailType}</div>
          </div>
        </div>
