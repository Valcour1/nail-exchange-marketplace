          ...
          <div className="overflow-y-auto max-h-[600px]">
            <Table>
              <TableHeader className="sticky top-0 bg-background">
                <TableRow>
                  <TableHead className="text-center border-r border-border w-1/3">Size</TableHead>
                  <TableHead className="text-center border-r border-border w-1/6">Bids (Buyers)</TableHead>
                  <TableHead className="text-center border-r border-border w-1/6">Asks (Sellers)</TableHead>
                  <TableHead className="text-center w-1/3">Size</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {!mounted ? (
                  ...
                  Array.from({ length: maxRows }, (_, index) => {
                    ...
                    return (
                      ...
                      >
                        {/* Bid Size */}
                        <TableCell className="relative text-center border-r border-border w-1/3">
                          {bid && (
                            <>
                              <div
                        ...
                        {/* Bid Price */}
                        <TableCell className="text-center border-r border-border w-1/6">
                          {bid && (
                        ...
                        {/* Ask Size */}
                        <TableCell className="relative text-center w-1/3">
                          {ask && (
                            <>
                              <div
